...
export const LeaveAReview: React.FC<{submitReview: any}> = (props) => {
    ...
    return (
        <div className='dropdown' style={{ cursor: 'pointer' }}>
            ...
            <ul id='submitReviewRating' className='dropdown-menu' aria-labelledy='dropdownMenuButton1'>
            ...
            {displayInput &&
                <form method="POST" action='#'>
                    ...
                    <div className='mb-3'>
                        ...
                        <textarea className='form-control' placeholder="Optional" id="submitReviewDescription"
